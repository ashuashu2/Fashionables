...
<div>
  ...
  <fieldset>
    ...
    <input value={state.Search} placeholder="Search your Products"
      onChange={(ev)=>dispatch({type:"SEARCH",payload:ev.target.value})} ></input>
  ...
  <div className="Price-div">
    ...
    <input type="range" name="" class="slider-container" step="1000" min="1000" max="5000" value={state.Price}
      onChange={(e)=>
  ...
  <fieldset className="category-div">
    ...
    <lable className="category-options">
      ...
      <input type="radio" onChange={()=>dispatch({type:"CATEGORY",payload:"Shirts"})}
      checked={state.Category==="Shirts"}
      ></input>
      Shirts</lable>
    <lable className="category-options">
      <input type="radio" onChange={()=>dispatch({type:"CATEGORY",payload:"Tshirt"})}
      checked={state.Category==="Tshirt"}
      ></input>Tshirts</lable>
    <lable className="category-options">

      <input type="radio" onChange={()=>dispatch({type:"CATEGORY",payload:"Top"})}
      checked={state.Category==="Top"}
      ></input>
      Top</lable>
    <lable className="category-options">
      <input type="radio" onChange={()=>dispatch({type:"CATEGORY",payload:"Dresses"})}
  ...
  <fieldset className="idealFor-div">
    ...
    <lable className="idealFor-options">
      <input type="checkbox" onChange={()=> {dispatch({ type:"MEN" })}}
      />
      Men
    </lable>
    <lable className="idealFor-options">
      <input type="checkBox" onChange={()=>dispatch({type:"WOMEN"})}
      ></input>Women</lable>
  ...
  <fieldset className="color-div">
    ...
    <lable className="color-options">
      <input type="radio" onChange={()=> {dispatch({ type:"COLOR" , payload :"Black" })}}
      checked={state.color==="Black"}
      />
      BLACK
    </lable>
    <lable className="color-options">
      <input type="radio" onChange={()=>dispatch({type:"COLOR" , payload :"White"})}
  ...
  <fieldset className="discount-div">
    ...
    <lable className="discount-options">
      <input type="checkBox" onChange={()=>dispatch({type:"FOURTY"})}></input>above 40%</lable>

    <lable className="discount-options">
      <input type="checkBox" onChange={()=>dispatch({type:"FIFTY"})}
  ...
  <fieldset className="ratings-div">
    ...
    <lable className="ratings-options">
      <input type="checkBox" onChange={()=>dispatch({type:"TWO"})}></input>2★ & above</lable>

    <lable className="ratings-options">
      <input type="checkBox" onChange={()=>dispatch({type:"ONE"})}
